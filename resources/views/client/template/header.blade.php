...
<head>
    ...
    <title>
        Camper Auction - @yield('title')
    </title>
    {{-- <link rel="shortcut icon" href="{{ asset('favicon.ico')}}" type="image/x-icon"> --}}
    <link rel="icon" href="{{asset('front-end-2/img/Thiết_kế_không_tên-removebg-preview.png')}}">
    <!-- BOOTSTRAP -->
    ...
    {{-- <link rel="stylesheet" href="{{ asset('front-end-2/css/style.css')}}"> --}}
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "108263384990854");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="left"> Camper Auction<span><i class="fa fa-phone"></i>Call us</span> +84 396752611</div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="right">
                            <ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6 text-center">
                        <img src="{{ asset('front-end-2/img/me_On__1_-removebg-preview.png') }}" width="420" height="400" alt="Trendify logo" />
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown
                            @if (Request::path() == 'chinh-sach-bao-mat' ||
                                Request::path() == 'chinh-sach-va-quy-dinh')
                            active
                            @endif">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">chính sách</a>
                            <ul class="dropdown-menu">
                                <li><a  href="{{ route('chinh-sach-bao-mat') }}">Chính sách bảo mật</a></li>
                                <li><a  href="{{ route('chinh-sach-va-quy-dinh') }}">Chính sách và quy định</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
