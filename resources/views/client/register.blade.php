...
<div class="margin-bottom-70px">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    <h1>Wellcome to Camper Auction</h1>
                    <div class="login col-md-7 no-padding-left">
                        <form action="{{ route('dang-ky') }}" method="POST">
                            ...
                            <div class="col-md-6 no-padding-left">	
                                <div class="submit col-md-8 no-padding-left">
                                    <button type="submit" class="btn btn-primary themSach">Đăng ký</button>
                                </div>
                            </div>	
                        </form>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <img src="{{ asset('front-end-2/img/616404770ae471633944695.png') }}" style="width: 500px;"/>
                    </div>
                </div>
...
<script>
   ...
   // {
      //  $('.themSach').click(function(e)
        //    {
              //  e.preventDefault(); 
              //  var $dienthoai = $('.sdt').val();
