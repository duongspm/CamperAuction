      ...
      <div class="card-body table-responsive">
        <form method="POST" action="{{ route('themsanpham') }}">
            ...
            <div class="form-group">
              ...
              <input name="tenSP" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="" placeholder="Nhập tên loại sản phẩm . . . ">
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
        <label for="exampleInputEmail1">Ngày và thời gian kết thúc đấu giá</label>
         <input name="ngayKT" type="datetime-local" value="2021-10-24T20:36:00" step="1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập ngày và thời gian kết thúc cho đấu giá">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Giá đấu</label>
            <input required="" name="giaBan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập giá đấu . . . ">
          </div>
