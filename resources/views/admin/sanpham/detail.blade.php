      ...
      <section class="invoice p-3">
        ...
        <div class="row invoice-info">
          ...
          <div class="form-group">
                <label for="exampleFormControlSelect1">Trạng thái</label>
                 @if ($sanpham->dgsp_trangthai == 0 )
                   <p class="badge bg-red"> Chưa đấu giá </p>
                  @else
            ...
            <p>Giá gốc: Chưa nhập hàng</p>
            @endif --}}
            <p>Giá đấu: {{number_format($sanpham->sp_giaban)}}</p>
          ...
          <div class="col-sm-4 invoice-col">
            ...
            @else
              <p>
                <img src="{{ asset('upload/sanpham') }}/{{ $sanpham->sp_anhdaidien }}" alt="Ảnh sản phẩn" width="300" height="400">
              </p>
            @endif
