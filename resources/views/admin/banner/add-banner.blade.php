    ...
    <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Thêm banner | Bài viết</h3>
          </div>
          <div class="card-body">
            <form method="POST" action="{{ route('them-banners') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input name="tieude" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required="" placeholder="Nhập tiêu đề . . . " >
                </div>
                <div class="form-group">
                    ...
                    <div class="row justify-content-center js-file-list" id="showImage">
                        <img src="{{ asset('front-end-2/img/Logo_camper.png') }}" alt="Ảnh banner" class="js-file-image" width="50%">
                    </div>
                  </div>
                <div class="form-group">
