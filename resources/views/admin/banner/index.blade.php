    ...
    <section class="content">
        ...
        @endif
          <div class="card-header">
            ...
            <br> --}}
            <a href="{{ route('them-banner') }}" class="btn-sm btn-success"><i class="fas fa-plus"></i> Thêm banner</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a class="btn btn-info btn-sm" href="{{ route('suatbanner', ['id'=>$item->bn_id]) }}">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Sửa
                            </a>
                            <a onclick="return confirm('Bạn có muốn thực hiện thao tác ?? Xóa banner này !!')" href="{{ route('xoabanner', ['id'=>$item->bn_id]) }}" class="btn btn-danger btn-sm" href="#">
