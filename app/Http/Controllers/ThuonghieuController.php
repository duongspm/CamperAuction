...
class ThuonghieuController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('hinhanh')) {
            ...
            //Cập nhật xong cập nhật lại loại để show ra kèm theo thông báo
            $success = Session::put('alert-info', 'Cập nhật dữ liệu thành công không cập nhật hình ảnh');
            return redirect()->route('danhsachthuonghieu');
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            $success = Session::put('alert-del', 'Xóa thương hiệu thành công !!!');
            return redirect()->route('danhsachthuonghieu');
        } catch (\Throwable $th) {
            //throw $th;
            return response()->json($th, 401);
            $success = Session::put('alert-del', $th);
            return redirect()->route('danhsachthuonghieu');
        }
    }
}
