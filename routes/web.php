...
Route::group(['prefix' => 'admin', 'middleware' => 'checkUser'], function () {
    ...
    //Duongg
    Route::get('/delete-category-product/{category_product_id}','LoaiController@delete_category_product');
   ...
   // Route::get('donhang/{id}/edit', 'DonhangController@capnhatvanchuyen')->name('capnhatvanchuyendonhang');
    ...
    Route::get('banner/{id}/delete','BannerController@destroy')->name('xoabanner');
...
Route::post('/post-auction','TrangchuController@saveAuction')->name('dau-gia-save');
//Giỏ hàng
...
Route::get('don-hang/{id}/{user}/detail','DonhangController@showgetOrders')->name('showgetOrders');
...
//Quên mật khẩu
Route::get('/quen-mat-khau','MailController@quen_mat_khau')->name('quen-mat-khau');
...
Route::get('/chinh-sach-va-quy-dinh', function () {
    return view('client.policies_regulations');
})->name('chinh-sach-va-quy-dinh');

//Chi tiet don hang
Route::get('chitiet/{id}/{user}/detail','DonhangController@chitiet')->name('chitiet');

//Sửa bannner
Route::get('banner/{id}/edit','BannerController@edit')->name('suatbanner');
Route::post('banner/{id}/edit', 'BannerController@update')->name('capnhatbanner');

//bình luận
Route::get('binhluan/edit/{id}','BinhluanController@edit')->name('editbinhluan');
Route::post('binhluan/update/{id}','BinhluanController@update')->name('updatebinhluan');
Route::get('binhluan/delete/{id}','BinhluanController@destroy')->name('deletebinhluan');

//trạng thái sản phẩm
Route::post('/post-status','TrangchuController@saveAuction')->name('dau-gia-save');

//getauction
Route::get('/san-pham-2', 'TrangchuController@getAllProduct2')->name('tatcasanpham-2');

//Add cart auction
Route::post('/add-cart-auction','GiohangController@addCartAuction')->name('add-cart-auction');